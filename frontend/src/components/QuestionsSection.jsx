    ...
    return (
        <div>
            <div className="questioncontainer">
                <div className="aboutheading"><span>Frequently Asked Questions</span></div>
                <div className="questionsContent">
                    <div className="questions">
                        <span>How do I know if I need a mental disorder test or mental health screening?
                        ...
                        {
                            openprofile1 && (
                                <div className="answer">Consider taking a test to assess your mental health if you’ve noticed changes in how you feel or in your ability to function for the last for two weeks or more. If you’ve found yourself feeling extra tired, irritable, anxious, unfocused, or sad lately, and these symptoms are interfering with your ability to engage in your day-to-day life, these could be signs that you could benefit from mental health treatment.</div>
                            )
                        }
                    </div>
                    <div className="questions">
                        <span>How can I test my mental health condition?
                    ...
                    <div className="questions">
                        ...
                        {
                            openprofile3 && (
                                <div className="answer">Online mental health tests can give you a better understanding of your mental health symptoms, but these tests can’t provide you with a diagnosis. A licensed therapist can discuss your test results with you, gather additional information, and then formulate a mental health diagnosis to support your treatment goals.</div>
                            )
                        }
                    </div>
                    <div className="questions">
                        <span>How accurate is a psychological test online?
